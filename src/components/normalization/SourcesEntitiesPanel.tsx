...
export default function SourcesEntitiesPanel() {
  ...
  return (
    <div className="rounded-xl border border-border bg-panel p-4 h-full">
      ...
      <div className="mt-4 rounded-lg border border-border bg-bg/20 p-3">
        ...
        <div className="mt-2 text-sm text-muted">
          Start with <span className="text-text font-semibold">Unmapped</span> and{' '}
          <span className="text-text font-semibold">Ambiguous</span>. Fixing these early prevents
          scoring errors and avoids bad pilot recommendations.
        </div>
      </div>
      <div className="mt-4 rounded-lg border border-border bg-bg/20 p-3">
        <div className="text-xs font-semibold text-text">Common pitfall</div>
        <div className="mt-2 text-sm text-muted">
          Owners and user fields often appear as groups in CMDB/tickets. Treat these as ambiguous
          until resolved.
        </div>
      </div>
    </div>
