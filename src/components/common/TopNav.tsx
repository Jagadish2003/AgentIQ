      ...
      <div className="mx-auto flex w-full items-center px-6 py-3">
        ...
        <div className="ml-auto flex items-center text-sm">
          {items.map((i) => {
            ...
            return (
              <div key={i.to} className="mr-4 border-r border-border pr-4 last:mr-0 last:border-r-0 last:pr-0">
                <Link
                  to={i.to}
          ...
          <div className="mr-4 flex cursor-pointer items-center gap-1 rounded-md px-3 py-2 pr-4 text-muted hover:bg-panel2 hover:text-text">
            Administrator
